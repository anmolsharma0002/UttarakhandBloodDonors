...
?>
			<br><br>
						<div class="container">
							<div class="row">
								...
								<i class="fa fa-key"></i>&nbspChange Password</font>
								</div>
							</div>	
		...
		<form class="form-horizontal"action="userpass.php" method="post">
					<div class="row">
							<div class="col-sm-4">
								<?php
								...
								<img src="<?php echo $row['photo'];?>" style="height:150px;border-radius:100px;width:150px;border:solid;border-width:2px;border-color:black"></td>
							</div>
					...
					<div class="col-sm-8">
								...
								<div class="form-group">
								<input class="form-control" type ="textbox"	name="old" id="tb" style="height:30px;width:100%;border-radius:5px" placeholder="Enter your old password" required	>
								</div>
								<div class="form-group">
								<input class="form-control" type ="textbox"	name="new" id="tb" style="height:30px;width:100%;border-radius:5px" placeholder="Set new password" required	>
								</div>
								<div class="form-group">
								<button id ="tb" class="b but" style="width:100px;border-radius:8px"><font style="font-family:arial;font-size:10pt"><i class="fa fa-pencil"></i>&nbsp&nbspUpdate</font></button></td></tr>				
								</div>
					</div>
				</div>
			</form>
