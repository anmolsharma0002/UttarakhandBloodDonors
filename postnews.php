	...
	<body >
		...
		<div class="container">
					...
					<div class="row">
								...
								<center><font Style="font-family:arial black;font-size:16pt;color:red">Post Latest Update</font></center>
					</div>			
			...
			<div class="col-sm-12">
				...
				<form class="form-horizontal" action="postupdate.php" method="post">
									...
									<div class="col-sm-3"></div>
										<div class="col-sm-6">
											<div class="row form-group">
												<label>Title</label>
												<input class="form-control" type ="textbox"	 name="title" id="tb" style="border-radius:5px" placeholder="Enter Title" required	>
											</div>	
											<div class="row form-group">
												<label>Description</label>
												<textarea class="form-control" 	 name="desp" id="tb" style="border-radius:5px" placeholder="Enter Description here..." required	></textarea>
											</div>
											<div class="row">
											<button id ="tb" class="b but" style="width:100px;border-radius:8px"><font style="font-family:arial;font-size:10pt"><i class="fa fa-pencil"></i>&nbsp&nbspPost</font></button>
											</div>
										</div>
									<div class="col-sm-3"></div>	
						</div>
